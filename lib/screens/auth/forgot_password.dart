      ...
      listener: (context,state){
        ...
        //   Navigator.of(context).pop();
          showModalBottomSheet(
            ...
            OTPVerification(fromPage:'forgotPassword',emailId: emailController.text.toString().toLowerCase(),),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    commonButton(
                      ...
                      isLoading: state.status == LiveScoreStatus.forgotPasswordLoading,
                      onTap: () {
                        ...
                        if(emailController.text.isEmpty){
                          ...
                          UiHelper.toastMessage("Please enter a valid email address");
                              ...
                              BlocProvider.of<LiveScoreCubit>(context).forgotPasswordCall(emailController.text.toString().toLowerCase());
                        }
                      },
                    ),
