...
class OTPVerification extends StatefulWidget {
  ...
  const OTPVerification(
      {super.key, required this.fromPage, required this.emailId});
        ...
        if (state.status == LiveScoreStatus.verifyOtpSuccess) {
          ...
          if (widget.fromPage == "forgotPassword") {
            ...
            CustomNavigator.pushReplacement(
                context: context, screen: const Login());
          }
        }
                            ...
                            children: [
                                ...
                                child: PinCodeTextField(
                                  ...
                                  boxShadows: [
                                    BoxShadow(
                                      ...
                                      // Only apply shadow at the top (negative Y-axis)
                                      blurRadius: 4.0,
                                      // Blur to spread the shadow softly
                                      spreadRadius:
                              ...
                              MyInkWell(
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: state.status ==
                                            LiveScoreStatus.resendOtpLoading
                                        ? const SizedBox(
                                            height: 25,
                                            width: 25,
                                        ...
                                        : mediumText14(context, 'Resend OTP',
                                            fontWeight: FontWeight.w500,
                                            textColor: isResendButtonEnabled
                              ...
                              commonButton(
                                  ...
                                  isLoading: state.status ==
                                      LiveScoreStatus.verifyOtpLoading,
                                  onTap: () {
