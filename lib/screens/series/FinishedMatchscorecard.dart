...
class FinishedMatchScorecardScreen extends StatefulWidget {
  ...
  FinishedMatchScorecardScreen(
      {super.key, required this.matchId, required this.winningTeam});
...
class _FinishedMatchScorecardScreenState
                    ...
                    for (var inning in teamAInnings!) {
                      if (inning.battingTeam.teamId == teamAId) {
                        ...
                        teamBName = finishedMatchDetailsResponse.data?.teamAName
                                .toString() ??
                            "";
                        teamAName = finishedMatchDetailsResponse.data?.teamBName
                                .toString() ??
                            "";
                      }
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          Spacer(),
                                          finishedMatchDetailsResponse.data
                                                      ?.result?.marginRuns !=
                                                  null
                                              ? Text(
                                                  '${widget.winningTeam} by ${finishedMatchDetailsResponse.data?.result?.marginRuns} runs ',
                                                  style: TextStyle(
                                                      color: Colors.black,
                                                      fontSize: 12,
                                                      fontWeight:
                                              ...
                                              : finishedMatchDetailsResponse
                                                      ...
                                                      null
                                                  ? Text(
                                                      '${widget.winningTeam} by ${finishedMatchDetailsResponse.data?.result?.marginWickets} wickets',
                                                      style: TextStyle(
                                                          color: Colors.black,
                                                          fontSize: 12,
                                                          fontWeight:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      crossAxisAlignment:
                                                                          CrossAxisAlignment
                                                                              .start,
                                                                      children: [
                                                                        Text(batter.playerName.toString() ==
                                                                                "Unknown Player"
                                                                            ? batter.playerId.toString()
                                                        ...
                                                        teamAExtras.total == 0
                                                            ...
                                                            : '${teamAExtras.total} '
                                                                ...
                                                                if (teamAExtras
                                                                        .noBalls !=
                                                                    0)
                                                                  'nb ${teamAExtras.noBalls}',
                                                                if (teamAExtras
                                                                        .penalty !=
                                                                    0)
                                                                  'p ${teamAExtras.penalty}',
                                                              ].join(', ')})',
                                                        style: TextStyle(
                                                          fontWeight:
                                                              FontWeight.bold,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ClipRRect(
                                                                            ...
                                                                            child:
                                                                                Image.asset("assets/images/iv_player_image.png"),
                                                                          ),
                                                                          SizedBox(
                                                                            width:
                                                                                5,
                                                                          ...
                                                                          Center(
                                                                            child:
                                                                              ...
                                                                              width: 100,
                                                                              child: Text(
                                                                                yetToBat?[index].name.toString() == "null" ? '${yetToBat?[index].id}' : '${yetToBat?[index].name}',
                                                                                maxLines: 2,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        commonText(
                                                                          data:
                                                                              "${finishedMatchDetailsResponse.data?.teamLineups?[teamAIndex].lineup?[index].name ?? ""}"
                                                                              "${isCaptain ? " (C)" : ""}${isWicketKeeper ? " (WK)" : ""}",
                                                                          fontSize:
                                                                              13,
                                                                          maxLines:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        commonText(
                                                                          data:
                                                                              "${finishedMatchDetailsResponse.data?.teamLineups?[teamBIndex].lineup?[index].name ?? ""}"
                                                                              "${isCaptain ? " (C)" : ""}${isWicketKeeper ? " (WK)" : ""}",
                                                                          fontSize:
                                                                              13,
                                                                          maxLines:
  ...
  void getAllInnings() {
    ...
    debugPrint(jsonEncode(partnerships), wrapWidth: 1024);
